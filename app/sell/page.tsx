      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex justify-center mb-5">
            <div className="inline-flex items-start gap-2 px-4 py-2 rounded-full text-sm font-medium" style={{ backgroundColor: '#FDF0EA', color: '#C4622D', border: '1px solid #F0C9B2' }}>
